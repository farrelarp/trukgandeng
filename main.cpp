...
void Grid() { 
 ...
 { 
 glVertex3f(i, -4.15, Z_MIN); 
 glVertex3f(i, -4.15, Z_MAX); 
 } 
 for(i=X_MIN;i<X_MAX;i+=gap) 
 { 
 glVertex3f(X_MIN, -4.15, i); 
 glVertex3f(X_MAX, -4.15, i); 
 } 
 glEnd(); 
}
...
{ 
 ...
 glTranslatef(0,-2.4,3.0);
 glRotated(180,1,0,0);
 cylinder(1.5,1.5,0.5);
 glPopMatrix();
 //belakang
 glPushMatrix();
 glClearColor(0, 0, 0, 0); // background color 
...
{ 
 ...
 glutCreateWindow("3D TRUCK FARREL ANDHIKA RIZKY PUTRA_24060120130071"); 
